...
class DatasetMapper_3RScan:
    ...
    def __call__(self, dataset_dict):
        ...
        # if self.is_train:
        #     panoptic_annotation_path = os.path.join("/media/sc/SSD1TB/dataset/entity_3rscan/train",sequence_id, name+".npz")
        # else:
        #     panoptic_annotation_path = os.path.join("/media/sc/SSD1TB/dataset/entity_3rscan/val",sequence_id, name+".npz")
